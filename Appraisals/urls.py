...
app_name = 'Appraisals'
urlpatterns = [
    path('user/', views.User_Appraisals, name='User_Appraisals'),
    path('manager/', views.Manager_Appraisals, name='Manager_Appraisals'),
    path('HR/', views.HR_Appraisals, name="HR_Appraisals"),
