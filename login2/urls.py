...
urlpatterns = [
    ...
    path('profile/all/<int:pk>/CreateQualifications', views.Create_Qualifications.as_view(), name='Create_Qualifications'),
    path('profile/all/<int:pk>/<int:mk>/DeleteQualifications', views.Delete_Qualifications.as_view(), name='Delete_Qualifications'),

    path('profile/HRM/<int:pk>/CreateQualifications', views.Create_Qualifications_HR.as_view(), name='HRM_Create_Qualifications'),
    path('profile/HRM/<int:pk>/<int:mk>/DeleteQualifications', views.Delete_Qualifications_HR.as_view(), name='HRM_Delete_Qualifications'),
]